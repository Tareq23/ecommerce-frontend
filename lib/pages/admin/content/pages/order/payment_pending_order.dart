...
class ViewPaymentPendingOrder extends StatefulWidget {
  const ViewPaymentPendingOrder({Key? key}) : super(key: key);

  @override
  State<ViewPaymentPendingOrder> createState() =>
      _ViewPaymentPendingOrderState();
}

class _ViewPaymentPendingOrderState extends State<ViewPaymentPendingOrder> {
  bool _check = false;
