...
class _UpdateCategoryState extends State<UpdateCategory> {
  final textEditingController = TextEditingController(text: categoryController.selectedCategory.value.name);
  Uint8List? webImage;
  ...
  void initState() {
    ...
    textEditingController.addListener(() {
      ...
      categoryController.selectedCategory.value.name = textEditingController.text.trim();
    });
                ...
                child: Form(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Obx((){
                        print('--------> category update name : ${categoryController.selectedCategory.value.name}');
                        if(categoryController.selectedCategory.value.name!=null){
                          return TextFieldWidget(
                            controller: textEditingController,
                            hint: 'Name',
                            initialValue: categoryController.selectedCategory.value.name??'name',
                            validator: (value){
                          ...
                          child: Obx((){
                            ...
                            return InkWell(
                              onTap: () async{
                                ...
                                await categoryController.updateCategoryName();
                              ...
                              child: Container(
                                ...
                                child: const CustomText(text: 'Name Update',color: TEXT_WHITE,size: 16,weight: FontWeight.w500,letterSpacing: 1.2,),
                              ),
                            );
                          })
                      ),
                          ...
                          child: Obx((){
                            ...
                            return InkWell(
                              ...
                              child: Container(
                                ...
                                child: const CustomText(text: 'Image Update',color: TEXT_WHITE,size: 16,weight: FontWeight.w500,letterSpacing: 1.2,),
                              ),
                            );
                          })
                      ),
